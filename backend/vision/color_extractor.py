...
class ColorExtractor:
    ...
    def extract_palette(self, image_path: str, color_count: int = 5, mask_path: str = None) -> List[Tuple[str, str]]:
    ...
    def _extract_palette_with_mask(self, image_path: str, mask_path: str, color_count: int) -> List[Tuple[str, str]]:
...
def extract_colors_from_image(image_path: str, mask_path: str = None, palette_size: int = 5) -> dict:
    ...
    return {
        ...
        "palette": [
            {"hex": hex_, "name": name} for hex_, name in palette
        ]
    }