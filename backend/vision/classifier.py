...
GARMENT_TYPES = [
    ...
    "blazer", "cardigan", "tank top", "crop top", "polo", "turtleneck",
    "jeans", "trousers", "shorts", "skirt", "leggings", "sweatpants",
    "dress", "jumpsuit", "romper",
    "sneakers", "boots", "sandals", "loafers", "heels", "flats", "oxfords",
    "scarf", "hat", "belt", "bag", "backpack", "sunglasses", "jewelry", "watch"
]

COLORS = [
    "red", "blue", "green", "yellow", "orange", "purple", "pink", "brown",
    "black", "white", "gray", "grey", "beige", "navy", "maroon", "teal",
    "olive", "coral", "lavender", "turquoise", "gold", "silver", "bronze"
]

PATTERNS = [
    "solid", "striped", "checked", "plaid", "floral", "polka dot", 
    "geometric", "abstract", "animal print", "paisley", "houndstooth"
]
...
class CLIPClassifier:
    ...
    def _load_model(self):
        ...
        try:
            ...
            raise ImportError("open-clip-torch not installed. Install with: pip install open-clip-torch")
    ...
    def find_similar_garments(
        ...
        garment_embeddings: List[np.ndarray],
        top_k: int = 5
