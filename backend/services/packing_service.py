    ...
    def plan_packing(
        ...
        for day in range(days):
            ...
            if best_outfit:
                ...
                available_outfits = [
                    o for o in available_outfits 
                    if not self._too_similar(o, [best_outfit])
                ]
            else:
        ...
        for garment in garments:
            ...
            for template in self.composer._get_templates(occasion):
                if garment.type in template:
                    ...
                    has_all = all(
                        any(g.id in current_garment_ids and g.type == t 
